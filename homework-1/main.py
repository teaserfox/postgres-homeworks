...
try:
    with params:
        with params.cursor() as cur:
            ...
            for i_employees in employees[1:]:  # заполнение данными таблицы employees_data
            ...
            for i_customers in customers[1:]:  # заполнение данными таблицы customers_data
            ...
            for i_orders in orders[1:]:  # заполнение данными таблицы orders_data
